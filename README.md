...
-  인덱스 예제
-  정규화 
    - DB 상에서 생기는 이상현상(삽입 , 삭제 , 수정) 이 생기지 않는 데이터베이스설계
    ...
    - BCNF 정규형 - 함수 종속성 X -> Y가 성립할때 모든 결정자X가 후보키(기본키가 될수 있는 속성) 이면 
    - 보통 BCNF까지 정규화를 함 
    - 4정규형(다치 종속성) , 5정규형(조인 종속성)
...
- 실무실습
 ...
 <img src="https://raw.githubusercontent.com/leekminxx/basic-database-2024/main/images/db007.png" width="870">
