...
SELECT o1.orderid
  ...
  -- 전체 판매액 118000 , 대한민국 고객판매액 46000
...
SELECT SUM(o.saleprice) AS '조인도 가능'
 FROM Orders AS o , Customer AS  c
  WHERE o.custid = c.cusitd
  AND  c.address LIKE '%대한민국%';

-- SELECT절 서브쿼리 , JOIN 으로 변경가능 이미 쿼리가 너무 복잡해서 더이상  테이블을 추가하기 힘들면,
-- 많이 사용                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               
-- 고객별 판매액을 보이시오 , GROUP BY 가 들어가면 SELECT 절에 반드시 집계함수가 들어가야 함!!
SELECT SUM(o.saleprice) AS '고객별 판매액' 
  -- , o.cusitd -- 다 봤으면 주석처리!
     , (SELECT [name] FROM Customer WHERE custid = o.cusitd) AS '고객명'
  FROM Oreders AS o
  GROUP BY o.custid;
  ...
  -- UPDATE에서도 사용 가능
  -- 사전준비
ALTER TABLE Oreders ADD bookname VARCHAR(40);
...
-- FROM 절 서브쿼리(인라인 뷰[가상테이블])          
-- 52. 고객별 판매액을 보이시오(서브쿼리 --> 조인)
-- 고객별 판매액 집계 쿼리가 FROM절에 들어가면 모든 속성(컬럼)에 이름이 저장되어야 함
SELECT b.total
    ,  c.name
